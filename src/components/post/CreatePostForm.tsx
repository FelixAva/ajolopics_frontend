...
//                             <div className="absolute inset-0 bg-red-500/0 group-hover:bg-red-500/40 flex items-center justify-center">
//                               <Trash2 size={24} className="text-white opacity-0 group-hover:opacity-100 drop-shadow-md" />
//                             </div>
//                           </div>
//                         ))}
//       </div>
    ...
    <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
      <div className="w-full">
        <label
          ...
          onDrop={handleDrop}
          className={`flex flex-col items-center justify-center w-full min-h-40 p-4 border-2 border-dashed rounded-xl cursor-pointer  ${
            isDragging
        ...
        >
          {files.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-6 text-dusty-olive">
              <DynamicIcon name="upload" size={32} className={`mb-3  ${isDragging ? 'scale-110 text-deep-teal' : ''}`} />
            ...
            <div className="w-full flex flex-col items-center gap-4">
              ...
              <p className="text-sm font-medium text-dusty-olive hover:text-deep-teal">+ Click here to add more photos</p>
            </div>
          )}
